(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.polybundle = {}));
  ...
  */
  ...
  const popOneValueForward = function(values, microGraph, translations) {
      ...
      if(popped) {
          ...
          if(location == undefined) { location = merge; }        let newKey = location(values.slice(0, i+1));
          return [newKey, i+1]
      }
